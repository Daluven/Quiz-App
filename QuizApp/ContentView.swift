...
struct ContentView: View {
    ...
    let quiz = [
        ...
        Quiz(question: "What does Loch mean in Scottish?", option1: "A Ravine", option2: "A hill", option3: "A monster", option4: "A lake", answer: 4),
    ...
    var body: some View {
        ZStack{
            ...
            .alert("Bzz Bzz!! You ran out of time!", isPresented: $isTimeOut) {
                Button(role: .none){
                    timeRemainding = 10
                    punchlineSize = 0.1
                    withAnimation(.spring()) {
